...
import * as lineUtils from '../utils/curveLine.js'
// import * as d3Tip from 'd3-tip';

class D3SimpleCurveChart extends React.Component {
    componentDidMount() {
        ...
        const maxValue = d3.max(serieArr, function (d) { return d.value; }); 
        ...
        let line = lineUtils.line()
            .curve(lineUtils.monotoneX)
            .x(function (d) { return x(d.time); })
            .y(function (d) { return y(d.value); });
        ...
        let label = serie.selectAll(".label") // 生成文字包层
          ...
          .enter().append("g")
            ...
            .attr('cursor','pointer')
            .attr("class", "label")
            .attr("transform", function (d, i) { return "translate(" + x(d.time) + "," + y(d.value) + ")"; });
...
export default D3SimpleCurveChart;